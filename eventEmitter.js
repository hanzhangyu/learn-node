...
rl.question('question: What do you think of Node.js? ' + process.env.isChild + '\n', (answer) => {
  console.log(`answer: Thank you for your valuable feedback: ${answer}` + process.env.isChild + '\n');
